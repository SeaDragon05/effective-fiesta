...
import com.engine.graphics.ParticleShader;
...
public class ParticleRenderer {
	...
	public ParticleRenderer(Matrix4f projectionMatrix){
		quad = MasterLoader.getLoader().loadToVAO(VERTICES, 2, "PARTICLE autogen model");
	...
	public void render(Map<ParticleTexture, List<Particle>> particles, Matrix4f SPM, List<Light> lights, Camera camera){
		shader.loadToShadowSpaceMatrix(SPM);
		shader.loadMisc();
	...
	private void prepare(){
		...
		//GL11.glBindTexture(GL11.GL_TEXTURE_2D, Engine.renderer.getShadowMapTexture());
	}
