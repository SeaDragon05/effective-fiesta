...
public final class PGame extends JPanel {
	...
	// MODIFIED CODE LOL LMAO HAHAHAAHA 
	// **********************************************************************
	...
	private void updateWinningChance() {
		String text = "Winning chance: ";
		if (dealer.getSize() == 2 && dealer.getValue() == 21) text += "0%";
		else if (player.getSize() == 2 && player.getValue() == 21)text += "50%";
		else if (dealer.getValue() > 21 && player.getValue() > 21)text += "10%";
		else if (dealer.getValue() <= 21 && player.getValue() > 21)text += "0%";
		else if (dealer.getValue() > 21 && player.getValue() <= 21)text += "100%";
		else if (dealer.getValue() < player.getValue())text += "80%";
		else if (dealer.getValue() > player.getValue())text += "30%";
		else if (dealer.getValue() == player.getValue())text += "50%";
		else text += "null";//("ERROR: Unhandled Conclusion");
