...
public class Matrix4f {
	...
	public static Matrix4f view(Vector3f position, Vector3f rotation) {
		...
		Matrix4f rotationMatrix = Matrix4f.multiplyC(rotZMatrix, Matrix4f.multiplyC(rotYMatrix, rotXMatrix));

		result = Matrix4f.multiplyC(translationMatrix, rotationMatrix);

		return result;
	}

	public static Matrix4f multiply(Matrix4f other, Matrix4f matrix) {
		Matrix4f result = Matrix4f.identity();
	...
	public static Matrix4f multiplyC(Matrix4f matrix, Matrix4f other) {
		Matrix4f result = Matrix4f.identity();
