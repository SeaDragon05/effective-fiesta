...
public class Sing {
	public static void main(String[] args) {
		Sam.speed = 45;
		Sam.outputLength = 3.4;
		Main.Say("Hello, I am a talking computer, and I will sing a song for you");
		...
		// Original copyright:
		// ℗ 2013 Back Lot Music, under exclusive license to Columbia Records, 
		...
		Sam.pitch = 52;
		speak("/H IH6 T6 "//It -> IHT -> /H IH6 T6
				+ "M4 AY4 T4 "
				+ "S4 IY4 M4 "
				+ "K4 R4 EY4 EY4 Z5 IY4 "
				+ "W6 AH6 T6 "
				+ "AY6 M6 "
				+ "B6 AW6 T4 "
				+ "T4 IH4 IH4 W4 "
		...
		Sam.pitch = 53;
		speak("S3 AH3 N3 SH3 AY3 IY3 IY3 N3 "
				+ "SH3 IY3 IY3 Z3 Z3 "
				+ "/H3 IY3 IY3 IY3 EH3 ER3 Q Q Q "
				+ "Y6 UW6 "
				+ "K6 AE6 N6 "
				+ "T6 EY6 K6 "
				+ "AH6 "
				+ "B4 R4 EY4 EY4 EY4 EY4 K4 Q K8 AH8");
		...
		Sam.pitch = 52;
		Sam.outputLength = 4;
		speak("AE8 AH8 M8 AH8 /H8 /H8 "
				+ "Q Q Q Q Q Q Q Q "
				+ "/H4 /H4 /H4 AO4 T4 "
				+ "EH4 EH4 ER4 ER4 "
				+ "B4 AO 4AO4 L4 UX4 UX3 UX3 UX4 UX4 N4 N4 N4 "
				+ "Q TH4 AE4 AE4 T4 "
				+ "K4 UX4 D4 "
				+ "G4 AX4 W4 "
				+ "D4 IH4 W4 "
		...
		Sam.pitch = 61;
		Sam.outputLength = 1;
		String lyric0 = "W4 IH4 TH4 "
				+ "TH4 IY4 Q "
				+ "EH4 EH4 EH4 EH4 EH4 EH4 EH4 ER4";// 
		//speak(lyric0);
		...
		speak("Q Q Q Q L4 AY4 AY4 K "
				+ "IH3 "
				+ "D OH4 OW4 N5 T5 "
				+ "K5 EH5 EH6 EH6 EH6 ER6 /H5 Q "
				+ "B5 EH5 EY5 IY5 B5 IY5 IY5 "
				+ "B4 AO4 IY4 "
				+ "TH4 AH4 AH4 "
				+ "W6 EY4 EY3 EY5 EY6 IY7 IY7");
		...
		speak("/H5 IY5 ER5 " 
				+ "K3 AH3 AH3 M3 "
				+ "B3 AE3 AE3 D3 "
				+ "N3 UX3 UX3 UW3 Z3 Z3 "
				+ "T5 AO5 K5 IH5 NX5 "
				+ "TH5 IH5 S5 "
				+ "AE5 N4 D4 "
				+ "TH4 AE4 AE4 AE4 AE4 AE4 AE4 T4");
	...
	private static void Chorus() {//(Because I'm happy)
		...
		//Sam.outputLength = ;
		speak("K3 L3 AE3 AE3 P3 "
				+ "AH3 L4 AO4 AO3 AO3 AX4 AX4 NX3 "
				+ "IH3 IH3 IH3 IH3 F3 "
				+ "Y3 Y5 UX5 UX5 UX5 UW5 "
				+ "F5 IY5 IY5 IY5 IY5 L5 "
				+ "L5 AY3 AY3 IY3 K3 "
				+ "TH3 AH3 AH3 AH3 T3 S3 "
				+ "W3 AH3 AH3 AH3 T3 "
				+ "Y3 UX3 UX3 UX3 UX3 "
				+ "W5 AH5 AH5 AH5 N5 N5 AH3 AH3 AH3 "
				+ "D3 UX3 UX3 UW3");
