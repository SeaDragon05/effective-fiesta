...
public class SamData {
	...
	//tab40672
	public static int stressInputTable[] =
	{
		'*', '1', '2', '3', '4', '5', '6', '7', '8'
	};

	//tab40682
	public static int signInputTable1[]={
		' ', '.', '?', ',', '-', 'I', 'I', 'E',
		'A', 'A', 'A', 'A', 'U', 'A', 'I', 'E',
		'U', 'O', 'R', 'L', 'W', 'Y', 'W', 'R',
		'L', 'W', 'Y', 'M', 'N', 'N', 'D', 'Q',
	...
	//tab40763
	public static int signInputTable2[] =
	{
		'*', '*', '*', '*', '*', 'Y', 'H', 'H',
		'E', 'A', 'H', 'O', 'H', 'X', 'X', 'R',
		'X', 'H', 'X', 'X', 'X', 'X', 'H', '*',
	...
	//tab45616???
	public static int phonemeStressedLengthTable[] = 
	{
	...
	//tab45536???
	public static int phonemeLengthTable[] = 
	{
