...
public class Main {
	...
	public static int audioQuality = 33000;// 33409 is the highest you can go without issue
	public static float audioQualityStep = 1102500 / audioQuality;
	static byte[] opBuffer;

	static boolean phonetic = true;

	public static void main(String[] args) {

		int[] input = getStringList(getPhonemes("Not everything I say is perfect!"));
	...
	public static void Say(String sentence) {
		int[] input = getStringList(getPhonemes(sentence));
	...
	public static int[] getPreMadeThing() {
		Sam.speed = 72;
		Sam.pitch = 64;
		// String injection = "/HEH2LOW1, /HAW AH YUX2 TUXDEY. AY /HOH3P YUX AH FIYLIHNX
		// OW4 KEY. ";// I am a talking computah. go ahead punk. make my day.
		// String injection = "EYAYOYAWOWUW ULUMUNQ YXWXRXLX/XDX";
		String injection = "AY1 AEM EY TAO4LXKIHNX KAX4MPYUX4TAH. GOW4 AH/HEH3D PAHNK.MEYK MAY7 DEY.";
		// Sam.pitch = 100;
		// String injection = "/HEHLOW? IHS EHNIY BAODIY THEHER? AY NIYD TUX GAXW
		// NAE8WW";
		// String injection = "/HEHLOW8W3W4W5W6W7, AY7 AEMM EY7IY8 TAO5LXKIHNX
		// KAX4MPYUX7TAH5. AY /HOH3P YUX AH FIYLIHNX OW4 KEY TUXDEY.";
		// String injection = " WAHV GOHS W8 W7 W6 W5 W4 W3 W2 W1 W1 W2 W3 W4 W5 W6 W7
		// W8 W8 W7 W6 W5 W4 W3 W2 W1 W1 W2 W3 W4 W5 W6 W7 W8 W8 W7 W6 W5 W4 W3 W2 W1 W1
		// W2 W3 W4 W5 W6 W7 W8 W8";
	...
	public static int[] getStringList(String injection) {
