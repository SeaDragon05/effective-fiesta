...
from cs415.views import WebUserAPIView, AddressTypeAPIView, UserAddressAPIView, UserInfoAPIView, UserPhoneAPIView, PhoneTypeAPIView, PageDataAPIView
from cs415.views import SingleWebUserAPIView, SingleAddressTypeAPIView, SingleWebUserEmailAPIView, SingleUserAddressAPIView, SinglePhoneTypeAPIView, SingleUserPhoneAPIView, SingleUserInfoAPIView, SinglePageDataAPIView, Login
...
urlpatterns = [
    ...
    path('users/email/<str:email>/', SingleWebUserEmailAPIView.as_view()),
    ...
    path('addresses/user/<int:web_user_id>/', SingleUserAddressAPIView.as_view()),
    ...
    path('phones/user/<int:web_user_id>/', SingleUserPhoneAPIView.as_view()),
    path('user-infos/', UserInfoAPIView.as_view()),
    path('user-infos/user/<int:web_user_id>/', SingleUserInfoAPIView.as_view()),
